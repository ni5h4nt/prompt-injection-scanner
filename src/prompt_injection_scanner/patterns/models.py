...
class Pattern(BaseModel):
    ...
    pattern_type: PatternType = Field(default=PatternType.REGEX, description="Pattern type")
    ...
    references: List[str] = Field(default_factory=list, description="Reference URLs/docs")
    examples: List[str] = Field(default_factory=list, description="Example matching strings")
